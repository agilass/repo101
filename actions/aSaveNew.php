        ...
        if (in_array($fileActualExt, $allowed)) {
            ...
            if ($file_error === 0) {
                if ($file_size < 50000000) { // almost 5 Mo 
                    $fileNameNew = $_POST['newIdEd'] . "." . $fileActualExt;
                    $fileDestination = "uploads/" . $fileNameNew;
                    $_POST["pathEd"] = $fileDestination;
                    ...
                    header("location:index.php?action=ListeNews&layout=Admin#" . $_POST['newIdEd']);
                    // $_SESSION["Added"] = "<script>
                    //     document.getElementById('Added').style.display='block';
                    //     document.getElementById('Added').style.color='#ff0911';
                    //     </script>";
                    $_SESSION["newIdEd"] = $_POST["newIdEd"];
                    ...
                    $_SESSION["newIdEd"] = $_POST["newIdEd"];
                    header("location:index.php?action=EditNew&layout=Admin&er=o");
                }
                ...
                $_SESSION["newIdEd"] = $_POST["newIdEd"];
                header("location:index.php?action=EditNew&layout=Admin&er=o&codeError=" . strval($file_error));
            }
        } else {
            foreach ($ids as $value) {
                unset($_SESSION[$value]);
